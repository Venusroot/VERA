...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $telefone_comercial = $_POST['telefone_comercial'] !== '' ? $_POST['telefone_comercial'] : 'Não informado';
    ...
    $documento = !empty($_POST['documento']) ? $_POST['documento'] : 'Não aplicável';
    ...
    // SQL atualizado com as 16 colunas
